 ...
 * Defines
 ******************************************************************************/
extern char globalFirmwareURL[128];
extern char globalFirmwareFilePath[128];
...
#define MAIN_WLAN_SSID "Detkin IOT North"//"goHAMCO!" //"Detkin IOT South" //"AirPennNet-Device" //"AbdiIphone"   /**< Destination SSID. Change to your WIFI SSID */
#define MAIN_WLAN_AUTH M2M_WIFI_SEC_WPA_PSK /**< Security manner */
#define MAIN_WLAN_PSK "n0rthC0untry"//"whatisthepassword" //"s0uthSide"//"penn1740wifi" //"abdi1234!"        /**< Password for Destination SSID. Change to your password. Please dont hack my WiFi router */

/** IP address parsing. */
#define IPV4_BYTE(val, index) ((val >> (index * 8)) & 0xFF)

/** Content URI for download. */
#define MAIN_HTTP_FILE_URL "http://20.169.241.98/TestB.bin"  ///< Change me to the URL to download your OTAU binary file from!
...
#define CLOUDMQTT_USER_ID "IntelliTank"

// Cloud MQTT PASSWORD
//#define CLOUDMQTT_USER_PASSWORD "BrsJBNVoQBl7"
#define CLOUDMQTT_USER_PASSWORD "VM_Port_23cool"
 ...
 */
static const char main_mqtt_broker[] = "172.172.165.38";
